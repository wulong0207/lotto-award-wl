...
public interface SportDrawWFDaoMapper {
	 ...
	 */
	List<SportDrawWFBO> findBySportAgainstInfoIdS(@Param("sportAgainstInfoIdS")List<Long> sportAgainstInfoIdS);
     ...
     */
	SportDrawWFBO findBySystemCode(@Param("systemCode")String systemCode);
}