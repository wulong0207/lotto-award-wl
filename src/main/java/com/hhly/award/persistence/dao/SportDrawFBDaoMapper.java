...
public interface SportDrawFBDaoMapper {
	 ...
	 */
    List<SportDrawFBBO> findBySportAgainstInfoIdS(@Param("sportAgainstInfoIdS")List<Long> sportAgainstInfoIdS);
     ...
     */
    SportDrawFBBO findBySystemCode(@Param("systemCode")String systemCode);
}