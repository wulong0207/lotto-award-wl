...
public class TicketInfoBO extends BaseBO {
	...
	public String toString() {
		return "TicketInfoBO [id=" + id + ", lotteryCode=" + lotteryCode + ", lotteryName=" + lotteryName
				+ ", lotteryIssue=" + lotteryIssue + ", userId=" + userId + ", ticketStatus=" + ticketStatus
				+ ", ticketMoney=" + ticketMoney + ", channelId=" + channelId + ", ticketChannel=" + ticketChannel
				+ ", orderCode=" + orderCode + ", winningStatus=" + winningStatus + ", preBonus=" + preBonus
				+ ", aftBonus=" + aftBonus + ", createTime=" + createTime + ", endTicketTime=" + endTicketTime
				+ ", sendChannelTime=" + sendChannelTime + ", comeOutTime=" + comeOutTime + ", receiptTime="
				+ receiptTime + ", lotteryTime=" + lotteryTime + ", startMatchtime=" + startMatchtime + ", contentType="
				+ contentType + ", sendTime=" + sendTime + ", buyScreen=" + buyScreen + ", lottoAdd=" + lottoAdd
				+ ", activitySource=" + activitySource + ", batchNum=" + batchNum + ", officialNum=" + officialNum
				+ ", winningDetail=" + winningDetail + ", multipleNum=" + multipleNum + ", addedBonus=" + addedBonus
				+ ", redCode=" + redCode + ", thirdNum=" + thirdNum + ", channelRemark=" + channelRemark
